    ...
    <section id="home" className={classes.hero}>
      <div className={classes.herobox}>
        <div className={classes.headerbox}>
          <h1 className={classes.heading}>DAKSH 2K24</h1>
          <h4 className={classes.caption}>Let's make a tech move!</h4>
          <p className={classes.date}>April 18-20th, 2024</p>
          <Link
            className={classes.anchorBtn}
            rel="noopener noreferrer"
            to="https://docs.google.com/forms/d/e/1FAIpQLSe-5RWEOqE3KY51iPrBDF8i_BNxZcvRdyqNfgY8QH5zT5ck7g/viewform?pli=1"
          >
            <Button
              link="https://docs.google.com/forms/d/e/1FAIpQLSe-5RWEOqE3KY51iPrBDF8i_BNxZcvRdyqNfgY8QH5zT5ck7g/viewform?pli=1"
